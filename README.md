# BRKCOL-2175 at Cisco Live Orlando 2018
...
```
docker build -t brkcol2175clus2018 .
```

The created image is called `brkcol2175clus2018`.

To start the notebook server execute this command:
```
docker run -it --rm --name jupyter -p 8888:8888 brkcol2175clus2018
```
...
> brkcol2175clus2018 : is the name of the image to run
